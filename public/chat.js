...
function motionAI_Open() {
  ...
  if (isMobile.any()) {
    ...
    /*
    Modal.open({
        content: '<iframe style="width:'+(window.innerWidth-100)+'px; height:'+(window.innerHeight-100)+'px; border:0" src="https://api.motion.ai/webchat/'+motionAI_botId+'"></iframe>',
        draggable: false,
